...
public class ConfettiManager {
    ...
    public ConfettiManager(ConfettoGenerator confettoGenerator,
        ...
        this.confettiView.addOnAttachStateChangeListener(onAttachStateChangeListener);
    ...
    public void terminate() {
        ...
        ((ViewGroup) confettiView.getParent()).removeView(confettiView);
        confettiView.removeOnAttachStateChangeListener(onAttachStateChangeListener);
        if (animationListener != null) {
